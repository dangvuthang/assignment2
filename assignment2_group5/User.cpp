...
string User::GetAddress() { return this->address; }
string User::GetPhone() { return this->phone; }
string User::GetRole() { return this->role; }
int User::GetNumberOfItemReturned() { return this->numberOfItemReturned; }
vector<string> User::GetListOfRentals() { return this->listOfRentals; }
void User::SetId() {
    string input;
    do {
